  ...
  async read() {
    ...
    try {
      ...
      usersSnapshot.forEach(doc => {
        ...
        this.data.users[id] = restoreFromFirebase(data)
      })
      ...
      chatsSnapshot.forEach(doc => {
        const data = doc.data()
        const id = data._id || doc.id
        this.data.chats[id] = restoreFromFirebase(data)
      })
      ...
      settingsSnapshot.forEach(doc => {
        const data = doc.data()
        const id = data._id || doc.id
        this.data.settings[id] = restoreFromFirebase(data)
      })
      ...
      statsSnapshot.forEach(doc => {
        const data = doc.data()
        const id = data._id || doc.id
        this.data.stats[id] = restoreFromFirebase(data)
      })
